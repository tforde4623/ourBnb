...
export const postUserReview = (review: Review) => async (dispatch: Dispatch) => {
...
export const getUserReviews = (locationId: number) => async (dispatch: Dispatch) => {
...
export const removeReview = (reviewId: number) => async (dispatch: Dispatch) => {
...
export const updateReview = (content: Review) => async (dispatch: Dispatch) => {
